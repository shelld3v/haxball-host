...
const NEW_UPDATE_MESSAGE = 'MỚI: Dự đoán đúng tỉ số và nhận chiếc băng đội trưởng hoặc suất đá chính ở trận sau với lệnh !predict';
...
function surrenderFunc(value, player) {
  ...
  room.sendChat(`Đội trưởng của ${TEAM_NAME[player.team]} đã lựa chọn đầu hàng, ${TEAM_NAME[player.team]} đã bị xử thua`);
