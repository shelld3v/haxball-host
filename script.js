...
function pickFunc(value, player) {
  ...
  if ( afkList.has(pickedPlayed.id) ) {
...
room.onGameStart = function(byPlayer) {
  ...
  clearPlayersAvatar();
  setRandomColors();
  // Move AFK players to top of the Spectators list
