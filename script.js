...
async function takePenalty() {
  ...
  room.sendChat(`Bây giờ ${getTag(room.getPlayer(penaltyTaker).name)} sẽ bước lên để thức hiện quả penalty`);
