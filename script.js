...
function updateBallKick(player) {
  ...
  if (
    ...
    if ( Math.abs(ballProperties.y + ballProperties.yspeed * (xOpponentGoal - ballProperties.x) / ballProperties.xspeed) < stadium.goalLine.y - stadium.ballRadius ) {
...
room.onTeamGoal = function(team) {
  ...
  // If we don't restart the game, the only player will have no chance of touching the ball
