...
function requestPick() {
  ...
  room.sendAnnouncement(`Đã đến lượt bạn, vui lòng chọn bằng lệnh !pick <tên hoặc tag> trong ${PICK_DEADLINE} giây (VD: !pick @De_Paul hoặc !pick paul)
